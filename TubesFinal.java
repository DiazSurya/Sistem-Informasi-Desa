...
//bagian diaz//
    public static void tampilkanSemua() {
        if (jumlahData == 0) {
            ...
            for (int i = 0; i < jumlahData; i++) {
                System.out.printf("| %-12s | %-25s | %-21s | %-21s | Rp %-11d |\n",
    ...
    public static void caribyDesa(String cariPendudukDesa) {
        boolean ditemukan = false;
        System.out.println("\n+----------------+--------------------------+----------------+--------------------------+-----------------+");
        System.out.printf("| %-14s | %-24s | %-14s | %-24s | %-15s |\n",
                "NIK", "NAMA LENGKAP", "DESA", "STATUS PERNIKAHAN", "PENGHASILAN");
        ...
        System.out.println("+----------------+--------------------------+----------------+--------------------------+-----------------+");
        if (ditemukan == false) {
            System.out.println("Tidak ada penduduk di desa " + cariPendudukDesa);
        }
        System.out.print("\nTekan enter untuk melanjutkan...");
        input.nextLine();
    }
